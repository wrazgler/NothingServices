...
public class NothingKafkaDbContextTests
{
    [Fact]
    ...
    private static async Task<NothingKafkaDbContext> GetDbContext()
    {
        var dbContext = new ServiceCollection()
            .AddInMemoryDatabase(nameof(NothingKafkaDbContextTests))
            .BuildServiceProvider()
            .GetRequiredService<NothingKafkaDbContext>();
